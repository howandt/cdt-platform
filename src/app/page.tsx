    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-12 px-6 text-center">
        ...
        <div className="flex justify-center gap-4 mt-8 flex-wrap">
          ...
          <Link href="#pricing">
            <button className="border border-white text-white hover:bg-white hover:text-indigo-700 px-6 py-3 rounded-lg">
              Se Pakker →
            </button>
          </Link>
        </div>
      ...
      <section className="py-12 px-6 max-w-5xl mx-auto grid md:grid-cols-3 gap-6 text-center">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-gray-800">Ny opdateret forskning og best practices indenfor special-pædagogik. Nye cases og teknikker tilføjes direkte i din Pro.</p>
        </div>
      </section>
      ...
      <section id="pricing" className="bg-white py-16 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="border border-purple-500 rounded-lg p-6 text-center bg-purple-50">
            ...
            <button className="bg-purple-600 hover:bg-purple-700 text-white w-full py-2 px-4 rounded">
              Start Pro
            </button>
          </div>
        </div>
